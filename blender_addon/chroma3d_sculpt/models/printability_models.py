...
class StaleState(str, Enum):
    ...
    STALE_HARDWARE_PROFILE = "STALE_HARDWARE_PROFILE"
    STALE_MATERIAL_PROFILE = "STALE_MATERIAL_PROFILE"
    STALE_PROCESS_CONTEXT = "STALE_PROCESS_CONTEXT"
    STALE_FEATURE_FLAGS = "STALE_FEATURE_FLAGS"
    STALE_PERFORMANCE_POLICY = "STALE_PERFORMANCE_POLICY"
